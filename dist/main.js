...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(23), __webpack_require__(142)(module)))
...
var lodash = __webpack_require__(56);
...
var pressKey_pressKey = function pressKey(device, keyCode) {
  try {
    displayLog("(press key: ".concat(keyCode, " / ").concat(devices_devicesKeyMap[device][keyCode], ")"));
    var logKey = {
      bubbles: false,
      cancelable: true,
    ...
    var up = crossBrowserKeyboardEvent("keyup", logKey);
...
var lastBody = {};
var dataForBody = {}; // _initKeyboardEvent_type
