...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(22), __webpack_require__(142)(module)))
...
var fixRegExpWellKnownSymbolLogic = __webpack_require__(137);
...
var forcedStringTrimMethod = __webpack_require__(145);
...
var es_promise = __webpack_require__(30);
...
var boxWidth = 30;
var fontSize = .9;
var baseStyle = "font-family: \"Courier New\", Courier, monospace; font-size:".concat(fontSize, "em; position: absolute; box-sizing: border-box; padding: .4em .3em; z-index: 999999999; border-radius: .2em; min-height:").concat(baseHeight, "em; overflow: hidden; text-overflow: ellipsis;");
...
var createLogConsole = function createLogConsole() {
  createElement('logConsole', "width: ".concat(boxWidth, "em; color: #fff; height: 16em; background-color: #689f38; right: ").concat(baseBorderMargin, "em;"), 1);
  var node = document.createElement('div');
...
var idConsole = function idConsole() {
  createElement('idConsole', "width: ".concat(boxWidth, "em; color: #fff; font-weight: bold; background-color: #454d66; right: ").concat(baseBorderMargin, "em;"), 0);
};
...
var es_regexp_exec = __webpack_require__(134);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.string.split.js
var es_string_split = __webpack_require__(136);
...
var displayId = function displayId(api) {
  document.getElementById('idConsole').innerText = "".concat(api);
};
var displayLog = function displayLog(msg) {
  //document.getElementById('logConsole').textContent += `\n${msg}`;
  if (document.getElementById('logConsole__inner').childElementCount >= 12) {
    var child = document.getElementById('logConsole__inner').firstElementChild;
    document.getElementById('logConsole__inner').removeChild(child);
  }

  var node = document.createElement('div');
  node.textContent = "".concat(msg);
...
var es_string_trim = __webpack_require__(143);

// CONCATENATED MODULE: ./src/utils/crossBrowserKeyboardEvent.js
...
var crossBrowser_initKeyboardEvent = function crossBrowser_initKeyboardEvent(type, dict) {
  var e;
  ...
  var _ctrlKey = localDict["ctrlKey"],
      ...
      _modifiersListArg = window._initKeyboardEvent_type > 3 ? ((_ctrlKey ? "Control" : "") + (_shiftKey ? " Shift" : "") + (_altKey ? " Alt" : "") + (_metaKey ? " Meta" : "") + (_altGraphKey ? " AltGraph" : "")).trim() : null,
      _key = localDict["key"] + "",
  ...
  } else if (window._initKeyboardEvent_type && "initKeyboardEvent" in e) {
    //https://developer.mozilla.org/en/DOM/KeyboardEvent#initKeyboardEvent()
    if (window._initKeyboardEvent_type == 1) {
      // webkit
  ...
  for (_prop_name in _keyboardEvent_properties_dictionary) {
    if (own(_keyboardEvent_properties_dictionary, _prop_name)) {
      if (e[_prop_name] != localDict[_prop_name]) {
        ...
        } catch (e) {//Some properties is read-only
        }
      }
    }
  }
...
/* harmony default export */ var crossBrowserKeyboardEvent = (crossBrowser_initKeyboardEvent);
...
// CONCATENATED MODULE: ./src/utils/keyboardEventInit.js
var keyboardEventInit = function keyboardEventInit(e) {
  try {
    ...
    */
    ...
    return (e["keyIdentifier"] || e["key"]) == "+" && (e["keyLocation"] || e["location"]) == 3 && (e.ctrlKey ? e.altKey ? // webkit
    1 : 3 : e.shiftKey ? 2 // webkit
    : 4 // IE9
    ) || 9 // FireFox|w3c
    ;
  } catch (__e__) {
...
/* harmony default export */ var utils_keyboardEventInit = (keyboardEventInit);
...
var lastProgressiveActionId = -1;
var lastStatus = 'waiting';
var lastBody = {}; // _initKeyboardEvent_type
...
var automation_sendRequest = function sendRequest() {
  displayLog("<- ".concat(lastStatus));
...
function checkStatus(response) {
  ...
  try {
    if (response.status === 200) {
      ...
      displayLog("error on checkStatus resp: ".concat(error));
...
var automation_instructionResponseHandler = function instructionResponseHandler(data) {
  try {
    displayLog("-> ".concat(data.action));

    if (data.path === undefined) {
      setTimeout(function () {
        automation_sendInstructionsRequest();
      }, 5000);
    } else {
      displayId(data.path);
    ...
    displayLog("error instructionResponseHandler: ".concat(e));
  }
};
...
var automation_responseHandler = function responseHandler(data) {
  ...
  try {
    ...
    if (data.action !== 'polling') {
      displayLog("".concat(progressiveActionId, " | -> ").concat(data.action));
...
var automation_doOnLoad = function doOnLoad() {
  try {
    if (getCookieByName('app-automation-actionApi') !== undefined) {
      ...
      displayLog("actionApi: ".concat(actionApi));
      displayId("reload: ".concat(actionApi));
      utils_deleteCookies();
      lastStatus = 'ok';
      lastBody = {};
      automation_sendRequest();
